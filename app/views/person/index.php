...
<div>
    ...
    <div style="background-color: yellow; width: fit-content; padding: 5px; float: right; margin-right: 2vw;"><a
                href="{! __WEB_ROOT__ !}/person/add">Add person</a></div>
</div>
<p style="clear: right;">
...
<div>
    <a href="{! __WEB_ROOT__ !}/person/edit?id={! $info->person_ID !}"
       style="display: inline-block; padding: 5px; margin-right: 20px; font-weight: bold; font-size: 20px">Sửa</a>
